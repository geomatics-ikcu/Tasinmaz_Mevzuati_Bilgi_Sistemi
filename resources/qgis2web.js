...
map.getView().fit([2974849.324012, 4675232.681059, 2998091.867168, 4688024.183270], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgis2webAttribution.innerHTML = '<a href="https://github.com/tomchadwin/qgis2web">Taşınmaz</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://openlayers.org/">Mevzuatı</a> &middot; ';
        var qgisAttribution = document.createElement('li');
        qgisAttribution.innerHTML = '<a href="https://qgis.org/">Bilgi Sistemi</a>';
